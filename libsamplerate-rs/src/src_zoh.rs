...
#[repr(C)]
pub struct ZOH_DATA {
    pub zoh_magic_marker: core::ffi::c_int,
    pub dirty: bool,
...
pub const ZOH_MAGIC_MARKER: core::ffi::c_int = 's' as i32
    + (('r' as i32) << 4 as core::ffi::c_int) + (('c' as i32) << 8 as core::ffi::c_int)
    + (('z' as i32) << 12 as core::ffi::c_int) + (('o' as i32) << 16 as core::ffi::c_int)
    + (('h' as i32) << 20 as core::ffi::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn zoh_get_name(
    mut src_enum: core::ffi::c_int,
) -> *const core::ffi::c_char {
    if src_enum == SRC_ZERO_ORDER_HOLD as core::ffi::c_int {
        return b"ZOH Interpolator\0" as *const u8 as *const core::ffi::c_char;
    }
...
unsafe extern "C" fn zoh_data_new(mut channels: core::ffi::c_int) -> *mut ZOH_DATA {
    let mut priv_0: *mut ZOH_DATA = calloc(
        1 as size_t,
        ::core::mem::size_of::<ZOH_DATA>() as size_t,
    ) as *mut ZOH_DATA;
    if !priv_0.is_null() {
        (*priv_0).zoh_magic_marker = ZOH_MAGIC_MARKER;
...
pub unsafe extern "C" fn zoh_state_new(
    ...
    (*state).private_data = zoh_data_new((*state).channels) as *mut core::ffi::c_void;
    if ((*state).private_data).is_null() {
...
unsafe extern "C" fn zoh_copy(mut state: *mut SRC_STATE) -> *mut SRC_STATE {
    ...
    let mut from_priv: *mut ZOH_DATA = (*state).private_data as *mut ZOH_DATA;
    let mut to_priv: *mut ZOH_DATA = calloc(
        1 as size_t,
        ::core::mem::size_of::<ZOH_DATA>() as size_t,
    ) as *mut ZOH_DATA;
    if to_priv.is_null() {
...
unsafe extern "C" fn zoh_close(mut state: *mut SRC_STATE) {
    if !state.is_null() {
        let mut zoh: *mut ZOH_DATA = (*state).private_data as *mut ZOH_DATA;
        if !zoh.is_null() {
            if !((*zoh).last_value).is_null() {
                free((*zoh).last_value as *mut core::ffi::c_void);
                (*zoh).last_value = 0 as *mut core::ffi::c_float;
            }
            free(zoh as *mut core::ffi::c_void);
