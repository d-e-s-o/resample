...
extern "C" {
    ...
    fn lrintf(__x: core::ffi::c_float) -> core::ffi::c_long;
    fn sinc_get_name(src_enum: core::ffi::c_int) -> *const core::ffi::c_char;
    fn sinc_get_description(src_enum: core::ffi::c_int) -> *const core::ffi::c_char;
    fn sinc_state_new(
        converter_type: core::ffi::c_int,
        channels: core::ffi::c_int,
        error: *mut SRC_ERROR,
    ) -> *mut SRC_STATE;
    fn linear_get_name(src_enum: core::ffi::c_int) -> *const core::ffi::c_char;
    fn linear_get_description(src_enum: core::ffi::c_int) -> *const core::ffi::c_char;
    fn linear_state_new(
        channels: core::ffi::c_int,
        error: *mut SRC_ERROR,
    ) -> *mut SRC_STATE;
    fn zoh_get_name(src_enum: core::ffi::c_int) -> *const core::ffi::c_char;
    fn zoh_get_description(src_enum: core::ffi::c_int) -> *const core::ffi::c_char;
    fn zoh_state_new(
        channels: core::ffi::c_int,
        error: *mut SRC_ERROR,
    ) -> *mut SRC_STATE;
...
pub unsafe extern "C" fn src_new(
    mut converter_type: core::ffi::c_int,
...
pub unsafe extern "C" fn src_clone(
    ...
    if orig.is_null() {
        if !error.is_null() {
            *error = SRC_ERR_BAD_STATE as core::ffi::c_int;
        }
        return 0 as *mut SRC_STATE;
    }
    if !error.is_null() {
        *error = SRC_ERR_NO_ERROR as core::ffi::c_int;
    }
    let mut state: *mut SRC_STATE = ((*(*orig).vt).copy)
        .expect("non-null function pointer")(orig);
    if state.is_null() {
        if !error.is_null() {
            *error = SRC_ERR_MALLOC_FAILED as core::ffi::c_int;
        }
    }
    return state;
}
...
pub unsafe extern "C" fn src_callback_new(
    ...
    let mut state: *mut SRC_STATE = 0 as *mut SRC_STATE;
    if func.is_none() {
        if !error.is_null() {
            *error = SRC_ERR_BAD_CALLBACK as core::ffi::c_int;
        }
        return 0 as *mut SRC_STATE;
    }
    if !error.is_null() {
...
pub unsafe extern "C" fn src_process(
    ...
    if state.is_null() {
        return SRC_ERR_BAD_STATE as core::ffi::c_int;
    }
    if (*state).mode as core::ffi::c_uint
        != SRC_MODE_PROCESS as core::ffi::c_int as core::ffi::c_uint
    {
        return SRC_ERR_BAD_MODE as core::ffi::c_int;
    }
    if data.is_null() {
        return SRC_ERR_BAD_DATA as core::ffi::c_int;
    }
    if ((*data).data_in).is_null() && (*data).input_frames > 0 as core::ffi::c_long
        || ((*data).data_out).is_null() && (*data).output_frames > 0 as core::ffi::c_long
    {
        return SRC_ERR_BAD_DATA_PTR as core::ffi::c_int;
    }
    if is_bad_src_ratio((*data).src_ratio) != 0 {
        return SRC_ERR_BAD_SRC_RATIO as core::ffi::c_int;
    }
    if (*data).input_frames < 0 as core::ffi::c_long {
        (*data).input_frames = 0 as core::ffi::c_long;
    }
    if (*data).output_frames < 0 as core::ffi::c_long {
        (*data).output_frames = 0 as core::ffi::c_long;
    }
    if (*data).data_in < (*data).data_out as *const core::ffi::c_float {
        if ((*data).data_in)
            .offset(
                ((*data).input_frames * (*state).channels as core::ffi::c_long) as isize,
            ) > (*data).data_out as *const core::ffi::c_float
        {
            return SRC_ERR_DATA_OVERLAP as core::ffi::c_int;
        }
    } else if ((*data).data_out)
        .offset(
            ((*data).output_frames * (*state).channels as core::ffi::c_long) as isize,
        ) > (*data).data_in as *mut core::ffi::c_float
    {
        return SRC_ERR_DATA_OVERLAP as core::ffi::c_int
    }
    (*data).input_frames_used = 0 as core::ffi::c_long;
    (*data).output_frames_gen = 0 as core::ffi::c_long;
    if (*state).last_ratio < 1.0f64 / SRC_MAX_RATIO as core::ffi::c_double {
        (*state).last_ratio = (*data).src_ratio;
    }
    if fabs((*state).last_ratio - (*data).src_ratio) < 1e-15f64 {
        error = ((*(*state).vt).const_process)
            .expect("non-null function pointer")(state, data) as core::ffi::c_int;
    } else {
...
pub unsafe extern "C" fn src_callback_read(
    mut state: *mut SRC_STATE,
    mut src_ratio: core::ffi::c_double,
    mut frames: core::ffi::c_long,
    mut data: *mut core::ffi::c_float,
) -> core::ffi::c_long {
    let mut src_data: SRC_DATA = SRC_DATA {
        data_in: 0 as *const core::ffi::c_float,
        data_out: 0 as *mut core::ffi::c_float,
        input_frames: 0,
        output_frames: 0,
        input_frames_used: 0,
        output_frames_gen: 0,
    ...
    let mut output_frames_gen: core::ffi::c_long = 0;
    let mut error: core::ffi::c_int = 0 as core::ffi::c_int;
    if state.is_null() {
        return 0 as core::ffi::c_long;
    }
    if frames <= 0 as core::ffi::c_long {
        return 0 as core::ffi::c_long;
    }
    if (*state).mode as core::ffi::c_uint
        != SRC_MODE_CALLBACK as core::ffi::c_int as core::ffi::c_uint
    {
    ...
    memset(
        &mut src_data as *mut SRC_DATA as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ::core::mem::size_of::<SRC_DATA>() as size_t,
    );
    ...
    output_frames_gen = 0 as core::ffi::c_long;
    while output_frames_gen < frames {
        let mut dummy: [core::ffi::c_float; 1] = [0.; 1];
        if src_data.input_frames == 0 as core::ffi::c_long {
            let mut ptr: *mut core::ffi::c_float = dummy.as_mut_ptr();
            ...
            if src_data.input_frames == 0 as core::ffi::c_long {
                src_data.end_of_input = 1 as core::ffi::c_int;
            }
        }
        ...
        src_data.data_in = (src_data.data_in)
            .offset(
                (src_data.input_frames_used * (*state).channels as core::ffi::c_long)
                    as isize,
            );
        src_data.input_frames -= src_data.input_frames_used;
        src_data.data_out = (src_data.data_out)
            .offset(
                (src_data.output_frames_gen * (*state).channels as core::ffi::c_long)
                    as isize,
            );
        src_data.output_frames -= src_data.output_frames_gen;
        output_frames_gen += src_data.output_frames_gen;
        if src_data.end_of_input == SRC_TRUE as core::ffi::c_int
            && src_data.output_frames_gen == 0 as core::ffi::c_long
        {
            break;
        }
    }
...
pub unsafe extern "C" fn src_set_ratio(
    mut state: *mut SRC_STATE,
    mut new_ratio: core::ffi::c_double,
) -> core::ffi::c_int {
    if state.is_null() {
        return SRC_ERR_BAD_STATE as core::ffi::c_int;
    }
    ...
    return SRC_ERR_NO_ERROR as core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn src_get_channels(
    mut state: *mut SRC_STATE,
) -> core::ffi::c_int {
    if state.is_null() {
        return -(SRC_ERR_BAD_STATE as core::ffi::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn src_reset(mut state: *mut SRC_STATE) -> core::ffi::c_int {
    if state.is_null() {
        return SRC_ERR_BAD_STATE as core::ffi::c_int;
    }
    ...
    (*state).saved_data = 0 as *const core::ffi::c_float;
    (*state).saved_frames = 0 as core::ffi::c_long;
...
pub unsafe extern "C" fn src_get_name(
    ...
    let mut desc: *const core::ffi::c_char = 0 as *const core::ffi::c_char;
...
#[no_mangle]
pub unsafe extern "C" fn src_get_version() -> *const core::ffi::c_char {
    return b"libsamplerate-0.2.2 (c) 2002-2008 Erik de Castro Lopo\0" as *const u8
        as *const core::ffi::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn src_is_valid_ratio(
    mut ratio: core::ffi::c_double,
) -> core::ffi::c_int {
    if is_bad_src_ratio(ratio) != 0 {
        return SRC_FALSE as core::ffi::c_int;
    }
    return SRC_TRUE as core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn src_error(mut state: *mut SRC_STATE) -> core::ffi::c_int {
    if !state.is_null() {
        return (*state).error as core::ffi::c_int;
    }
    return SRC_ERR_NO_ERROR as core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn src_strerror(
    mut error: core::ffi::c_int,
) -> *const core::ffi::c_char {
    match error {
        0 => return b"No error.\0" as *const u8 as *const core::ffi::c_char,
        1 => return b"Malloc failed.\0" as *const u8 as *const core::ffi::c_char,
        2 => {
            return b"SRC_STATE pointer is NULL.\0" as *const u8
                as *const core::ffi::c_char;
        }
        3 => {
            return b"SRC_DATA pointer is NULL.\0" as *const u8
                as *const core::ffi::c_char;
        }
        4 => {
        ...
        10 => return b"Bad converter number.\0" as *const u8 as *const core::ffi::c_char,
        11 => {
            return b"Channel count must be >= 1.\0" as *const u8
                as *const core::ffi::c_char;
        }
        12 => {
...
pub unsafe extern "C" fn src_short_to_float_array(
    mut in_0: *const core::ffi::c_short,
    mut out: *mut core::ffi::c_float,
    mut len: core::ffi::c_int,
) {
    let mut i: core::ffi::c_int = 0 as core::ffi::c_int;
    while i < len {
        *out.offset(i as isize) = (*in_0.offset(i as isize) as core::ffi::c_int
            as core::ffi::c_double
            / (1.0f64 * 0x8000 as core::ffi::c_int as core::ffi::c_double))
            as core::ffi::c_float;
        i += 1;
    }
}
...
pub unsafe extern "C" fn src_float_to_short_array(
    mut in_0: *const core::ffi::c_float,
    mut out: *mut core::ffi::c_short,
    mut len: core::ffi::c_int,
) {
    let mut i: core::ffi::c_int = 0 as core::ffi::c_int;
    while i < len {
        let mut scaled_value: core::ffi::c_float = 0.;
        scaled_value = *in_0.offset(i as isize) * 32768.0f32;
        if scaled_value >= 32767.0f32 {
            *out.offset(i as isize) = 32767 as core::ffi::c_short;
        } else if scaled_value <= -32768.0f32 {
            *out.offset(i as isize) = -(32768 as core::ffi::c_int) as core::ffi::c_short;
        } else {
            *out.offset(i as isize) = lrintf(scaled_value) as core::ffi::c_short;
        }
        i += 1;
    }
}
...
pub unsafe extern "C" fn src_int_to_float_array(
    mut in_0: *const core::ffi::c_int,
    mut out: *mut core::ffi::c_float,
    mut len: core::ffi::c_int,
) {
    let mut i: core::ffi::c_int = 0 as core::ffi::c_int;
    while i < len {
        *out.offset(i as isize) = (*in_0.offset(i as isize) as core::ffi::c_double
            / (8.0f64 * 0x10000000 as core::ffi::c_int as core::ffi::c_double))
            as core::ffi::c_float;
        i += 1;
    }
}
...
pub unsafe extern "C" fn src_float_to_int_array(
    ...
    let mut scaled_value: core::ffi::c_double = 0.;
    let mut i: core::ffi::c_int = 0 as core::ffi::c_int;
    while i < len {
        scaled_value = *in_0.offset(i as isize) as core::ffi::c_double
            * (8.0f64 * 0x10000000 as core::ffi::c_int as core::ffi::c_double);
        if scaled_value >= 1.0f64 * 0x7fffffff as core::ffi::c_int as core::ffi::c_double
        {
            *out.offset(i as isize) = 0x7fffffff as core::ffi::c_int;
        } else if scaled_value
            <= -8.0f64 * 0x10000000 as core::ffi::c_int as core::ffi::c_double
        {
            *out.offset(i as isize) = -(1 as core::ffi::c_int)
                - 0x7fffffff as core::ffi::c_int;
        } else {
            *out.offset(i as isize) = lrint(scaled_value) as core::ffi::c_int;
        }
        i += 1;
    }
}
unsafe extern "C" fn psrc_set_converter(
    ...
    let mut temp_error: SRC_ERROR = SRC_ERR_NO_ERROR;
    let mut state: *mut SRC_STATE = 0 as *mut SRC_STATE;
    ...
    if !error.is_null() {
        *error = temp_error as core::ffi::c_int;
    }
    return state;
}
